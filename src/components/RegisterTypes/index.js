...
import { RegisterContainer, RegisterTypeButton,
RegisterLabel } from "./styles";

//abaixo: sendTypeChanged atualiza a pg New
//abaixo: type recebe "receita" setado em useState na pg New
export default function RegisterTypes({type, sendTypeChanged}){
    ...
    return(
        <RegisterContainer>
            ...
            <RegisterTypeButton 
            cheked={typeChecked === "receita" ? true : false}
            ...
            <RegisterTypeButton 
            cheked={typeChecked === "despesa" ? true : false}
